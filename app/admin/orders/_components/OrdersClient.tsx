        ...
        {ALL_STATUSES.map((status) => {
          ...
          return (
            <motion.button
              ...
              style={{
                borderColor: isActive ? cfg.border : "#EDE5D8",
            ...
            >
              ...
              <div className="text-[#A89585] text-[0.72rem] mt-0.5">
                {cfg.label}
              </div>
            </motion.button>
          );
      ...
      <div className="bg-white border-[1.5px] border-[#EDE5D8] rounded-[14px] px-4 py-[0.875rem] mb-5 flex gap-3 flex-wrap items-center">
        ...
        <div className="flex gap-1 flex-wrap">
          <button
            ...
            style={{
              borderColor: !statusFilter ? "#B89A5A" : "#EDE5D8",
              background: !statusFilter ? "#FBF6EC" : "transparent",
              color: !statusFilter ? "#B89A5A" : "#A89585",
            }}
          >
            الكل ({allCount})
          </button>
        ...
        <div className="w-px h-6 bg-[#EDE5D8] mx-1" />
        ...
        <div className="relative flex-[1_1_200px] min-w-[160px]">
          ...
          <input
            ...
            className="w-full pl-3 pr-9 py-[0.45rem] rounded-[8px] border-[1.5px] border-[#EDE5D8] bg-[#FAF7F2] text-[#3D2B1F] text-[0.82rem] font-inherit outline-none box-border"
      ...
      <div className="bg-white border-[1.5px] border-[#EDE5D8] rounded-[16px] overflow-hidden">
        ...
        {!isLoading && orders.length === 0 && (
          <div className="py-16 text-center">
            <ShoppingBag size={40} color="#EDE5D8" className="mx-auto mb-4" />
                ...
                {orders.map((order, idx) => (
                  <>
                    <motion.tr
                      ...
                      className="border-b border-[#F5EFE6] cursor-pointer transition-colors duration-150 hover:bg-[#FAF7F2]"
                    >
                      {/* Order ID */}
                      <td className="px-4 py-[0.875rem]">
                        <div
                          className="text-[#6B4C3B] font-semibold text-[0.8rem] max-w-[120px] overflow-hidden text-ellipsis text-right"
                          style={{ direction: "ltr" }}
                          title={order.id}
                        >
                          #{order.id.slice(-8).toUpperCase()}
                        </div>
                        <div className="text-[#A89585] text-[0.72rem] mt-px">
                      ...
                      <td className="px-4 py-[0.875rem]">
                        <div className="flex items-center gap-[0.625rem]">
                          <div className="w-9 h-9 rounded-full overflow-hidden border-[1.5px] border-[#EDE5D8] bg-[#F5EFE6] flex items-center justify-center shrink-0">
                            {order.user.image ?
                              <Image
                              ...
                              />
                            : <User size={16} color="#A89585" />}
                          </div>
                          <div>
                            <div className="text-[#3D2B1F] font-semibold text-[0.85rem]">
                              {order.user.name ?? "—"}
                            </div>
                            <div
                      ...
                      {/* Amount */}
                      <td className="px-4 py-[0.875rem]">
                        <div className="text-[#3D2B1F] font-bold text-[0.9rem]">
                          {order.totalPrice.toLocaleString("en-US")} ج
                        </div>
                        <div className="text-[#6A9E7F] text-[0.75rem] mt-px">
                          ربح:{" "}
                          {(
                        ...
                        {order.coupon && (
                          <div className="text-[#7A9BBF] text-[0.72rem]">
                            كوبون: {order.coupon}
                          </div>
                        )}
                      </td>
                      ...
                      {/* Payment */}
                      <td className="px-4 py-[0.875rem]">
                        <span className="text-[#6B4C3B] text-[0.82rem]">
                          {order.paymentMethod}
                        </span>
                      </td>
                      ...
                      <td className="px-4 py-[0.875rem]">
                        ...
                        <div className="flex items-center gap-1 text-[#A89585] text-[0.72rem] mt-0.5">
                          <MapPin size={11} />
                      ...
                      <td className="px-4 py-[0.875rem]">
                        <div className="flex gap-1.5">
                          <button
                            ...
                            className="w-[34px] h-[34px] rounded-[8px] border-[1.5px] border-[#EDE5D8] bg-[#FAF7F2] cursor-pointer flex items-center justify-center text-[#7A9BBF] transition-all duration-150"
                          ...
                          <button
                            ...
                            className="px-[0.875rem] h-[34px] rounded-[8px] border-[1.5px] border-[#DDD0B0] bg-[#FBF6EC] text-[#B89A5A] font-semibold text-[0.78rem] cursor-pointer font-inherit whitespace-nowrap"
                          >
                            تغيير الحالة
                          </button>
                        </div>
                        ...
                        <tr key={`${order.id}-expanded`}>
                          <td colSpan={7} className="p-0">
                            <motion.div
                              ...
                              className="overflow-hidden bg-[#FAF7F2] border-b border-[#EDE5D8]"
                            >
                              <div className="px-6 py-4">
                                <div className="text-[#6B4C3B] font-semibold text-[0.85rem] mb-3">
                                  المنتجات في الطلب:
                                </div>
                                <div className="flex flex-wrap gap-[0.625rem]">
                                  {order.orderItems.map((item) => (
                                    <div
                                      key={item.id}
                                      className="flex items-center gap-[0.625rem] bg-white border border-[#EDE5D8] rounded-[10px] px-3 py-2 min-w-[200px]"
                                    >
                                      <div className="w-10 h-10 rounded-[8px] overflow-hidden border border-[#EDE5D8] shrink-0 bg-[#F5EFE6]">
                                        <Image
                                      ...
                                      <div>
                                        <div className="text-[#3D2B1F] font-semibold text-[0.82rem]">
                                          {item.product.name}
                                        </div>
                                ...
                                <div className="mt-3 text-[#A89585] text-[0.8rem]">
        ...
        <div className="flex items-center justify-between mt-4 px-5 py-[0.875rem] bg-white border-[1.5px] border-[#EDE5D8] rounded-[12px] flex-wrap gap-3">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              ...
              style={{
                background:
                  orders.length < ORDERS_PER_PAGE ? "#FAF7F2" : "#FFFFFF",
                color: orders.length < ORDERS_PER_PAGE ? "#C9B9AD" : "#3D2B1F",
                cursor:
